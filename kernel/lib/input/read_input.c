...
read_input_listener_t* listeners[256];
bool listener_existent = false;
void read_input_handle_keystroke(char keystroke, read_input_listener_t* this) {
 ...
 */
void read_input_get_keystrokes(read_input_listener_t* this, uint8_t* buffer[256]) {
    uint8_t length =
...
void read_input_init_listener(read_input_listener_t* listener) {
