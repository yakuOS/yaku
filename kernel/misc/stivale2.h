...
typedef struct stivale2_header_tag_framebuffer stivale2_header_tag_framebuffer_t;
...
typedef struct stivale2_header_tag_slide_hhdm stivale2_header_tag_slide_hhdm_t;
...
typedef struct stivale2_pmr stivale2_pmr_t;
...
typedef struct stivale2_struct_tag_kernel_base_address
    stivale2_struct_tag_kernel_base_address_t;
...
typedef struct stivale2_struct_tag_framebuffer stivale2_struct_tag_framebuffer_t;
...
typedef struct stivale2_struct_tag_terminal stivale2_struct_tag_terminal_t;
...
typedef struct stivale2_module stivale2_module_t;
...
typedef struct stivale2_struct_tag_modules stivale2_struct_tag_modules_t;
...
typedef struct stivale2_struct_tag_kernel_file stivale2_struct_tag_kernel_file_t;
...
typedef struct stivale2_struct_tag_kernel_file_v2 stivale2_struct_tag_kernel_file_v2_t;
...
typedef struct stivale2_guid stivale2_guid_t;
...
typedef struct stivale2_struct_tag_boot_volume stivale2_struct_tag_boot_volume_t;
...
typedef struct stivale2_struct_tag_kernel_slide stivale2_struct_tag_kernel_slide_t;
...
typedef struct stivale2_struct_tag_pxe_server_info stivale2_struct_tag_pxe_server_info_t;
...
typedef struct stivale2_struct_tag_mmio32_uart stivale2_struct_tag_mmio32_uart_t;
...
typedef struct stivale2_struct_tag_dtb stivale2_struct_tag_dtb_t;
...
typedef struct stivale2_struct_tag_hhdm stivale2_struct_tag_hhdm_t;
